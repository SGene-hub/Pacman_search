...
def readCommand(argv):
    ...
    parser.set_defaults(generateSolutions=False, edxOutput=False, gsOutput=False, muteOutput=True, printTestCase=False, noGraphics=False)
...
if __name__ == '__main__':
    ...
    if options.runTest != None:
        ...
        """
        a = evaluate(options.generateSolutions, options.testRoot, moduleDict,
            gsOutput=options.gsOutput,
            edxOutput=options.edxOutput, muteOutput=options.muteOutput, printTestCase=False,
            questionToGrade=options.gradeQuestion, display=getDisplay(options.gradeQuestion!=None, options))"""
        a = evaluate(options.generateSolutions, options.testRoot, moduleDict, muteOutput=False)
        q1 = a['q1'] #round(a['q1']/3*2,2) # 2 pts
        q2 = a['q2'] #round(a['q2']/3*2,2) # 2 pts
        q3 = a['q3']
        q4 = a['q4']
        q5 = a['q5']
        q6 = a['q6']
